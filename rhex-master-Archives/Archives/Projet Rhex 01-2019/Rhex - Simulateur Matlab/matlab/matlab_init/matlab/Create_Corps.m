function [ Corps ] = Create_Corps( Base_corps )
...
% Affichage
Corps.prtCorps1 = line([p0(1) p1(1)], [p0(2) p1(2)], [p0(3) p1(3)], 'Color', 'r', 'LineWidth', 2, 'LineStyle', '-');
Corps.prtCorps2 = line([p0(1) p2(1)], [p0(2) p2(2)], [p0(3) p2(3)], 'Color', 'k', 'LineWidth', 2, 'LineStyle', '-');
Corps.prtCorps3 = line([p0(1) p3(1)], [p0(2) p3(2)], [p0(3) p3(3)], 'Color', 'b', 'LineWidth', 2, 'LineStyle', '-');
Corps.prtCorps4 = line([p0(1) p4(1)], [p0(2) p4(2)], [p0(3) p4(3)], 'Color', 'r', 'LineWidth', 2, 'LineStyle', '-');
Corps.prtCorps5 = line([p0(1) p5(1)], [p0(2) p5(2)], [p0(3) p5(3)], 'Color', 'k', 'LineWidth', 2, 'LineStyle', '-');
Corps.prtCorps6 = line([p0(1) p6(1)], [p0(2) p6(2)], [p0(3) p6(3)], 'Color', 'b', 'LineWidth', 2, 'LineStyle', '-');
